...
public class CalculatorController {
    private final CalculatorSerivce calculatorSerivce;

    public CalculatorController(CalculatorSerivce calculatorSerivce) {
    ...
    public String plus(@RequestParam("num1") int num1, @RequestParam("num2") int num2) {
        return num1 + " + " + num2 + " = " + calculatorSerivce.plus(num1, num2);
    }
    @GetMapping("/minus")
